...
result5BAC =
    ...
    [TZmarkup{tzloc = TextLoc{tlpage = "", tlline = 1},
     ...
     TZmarkup{tzloc = TextLoc{tlpage = "", tlline = 6},
              tztext = TextWithMarks{twm = "English", twmMarks = []},
              tztok = BuchSprache, tzlang = NoLanguage},
     TZleer{tzloc = TextLoc{tlpage = "", tlline = 7}},
     TZtext{tzt = AllCaps0, tzloc = TextLoc{tlpage = "", tlline = 8},
            tztext = TextWithMarks{twm = "PREFACE", twmMarks = []},
            tzlang = NoLanguage},
     TZleer{tzloc = TextLoc{tlpage = "", tlline = 9}},
     ...
     TZtext{tzt = AllCaps0, tzloc = TextLoc{tlpage = "", tlline = 21},
            tztext = TextWithMarks{twm = "", twmMarks = []},
            tzlang = NoLanguage},
     TZtext{tzt = Fussnote0, tzloc = TextLoc{tlpage = "", tlline = 22},
            tztext =
              TextWithMarks{twm =
     ...
     TZtext{tzt = Kurz0, tzloc = TextLoc{tlpage = "", tlline = 25},
            ...
            tzlang = NoLanguage},
     TZtext{tzt = Fussnote0, tzloc = TextLoc{tlpage = "", tlline = 26},
            tztext =
              TextWithMarks{twm =
     ...
     TZtext{tzt = AllCaps0, tzloc = TextLoc{tlpage = "", tlline = 29},
            tztext =
     ...
     TZtext{tzt = Text0, tzloc = TextLoc{tlpage = "", tlline = 34},
            tztext =
              TextWithMarks{twm = "A frog began to groan and quake.",
                            twmMarks = []},
            tzlang = NoLanguage},
     TZleer{tzloc = TextLoc{tlpage = "", tlline = 35}},
     ...
     TZtext{tzt = Text0, tzloc = TextLoc{tlpage = "", tlline = 38},
            tztext =
              TextWithMarks{twm = "He trod on twenty of them in an hour.",
                            twmMarks = []},
            tzlang = NoLanguage},
     TZleer{tzloc = TextLoc{tlpage = "", tlline = 39}},
     ...
     TZtext{tzt = Fussnote0, tzloc = TextLoc{tlpage = "", tlline = 43},
            tztext =
              TextWithMarks{twm = "[9]Phaedrus, I. 30.",
                            twmMarks = [(0, "[9]")]},
            tzlang = NoLanguage},
     TZleer{tzloc = TextLoc{tlpage = "", tlline = 44}},
     TZleer{tzloc = TextLoc{tlpage = "", tlline = 45}},
...
result6BAC =
    [TZmarkup{tzloc = TextLoc{tlpage = "", tlline = 1},
     ...
     TZtext{tzt = Text0, tzloc = TextLoc{tlpage = "", tlline = 2},
            tztext =
              TextWithMarks{twm =
            ...
            tzlang = NoLanguage},
     TZleer{tzloc = TextLoc{tlpage = "", tlline = 3}},
     TZtext{tzt = Kurz0, tzloc = TextLoc{tlpage = "", tlline = 4},
            tztext =
     ...
     TZtext{tzt = Kurz0, tzloc = TextLoc{tlpage = "", tlline = 8},
            ...
            tzlang = NoLanguage},
     TZtext{tzt = Kurz0, tzloc = TextLoc{tlpage = "", tlline = 9},
            tztext =
              TextWithMarks{twm = "[Last updated: December 20, 2011]",
                            twmMarks = []},
            tzlang = NoLanguage},
     TZleer{tzloc = TextLoc{tlpage = "", tlline = 10}},
     TZmarkup{tzloc = TextLoc{tlpage = "", tlline = 11},
              tztext = TextWithMarks{twm = "English", twmMarks = []},
              tztok = BuchSprache, tzlang = NoLanguage},
     TZleer{tzloc = TextLoc{tlpage = "", tlline = 12}},
     TZleer{tzloc = TextLoc{tlpage = "", tlline = 13}},
     ...
     TZmarkup{tzloc = TextLoc{tlpage = "", tlline = 29},
              tztext =
                TextWithMarks{twm = "THE MILLENNIUM FULCRUM EDITION 3.0",
                              twmMarks = []},
              tztok = BuchPublikationDetail, tzlang = NoLanguage},
     TZleer{tzloc = TextLoc{tlpage = "", tlline = 30}},
     ...
     TZmarkup{tzloc = TextLoc{tlpage = "", tlline = 37},
              tztext = TextWithMarks{twm = "Deutsch", twmMarks = []},
              tztok = BuchSprache, tzlang = NoLanguage},
     ...
     TZmarkup{tzloc = TextLoc{tlpage = "", tlline = 41},
              tztext = TextWithMarks{twm = "English", twmMarks = []},
              tztok = BuchSprache, tzlang = NoLanguage},
     TZleer{tzloc = TextLoc{tlpage = "", tlline = 42}},
     ...
     TZmarkup{tzloc = TextLoc{tlpage = "", tlline = 62},
              tztext = TextWithMarks{twm = "", twmMarks = []},
              tztok = BuchIgnoreTo, tzlang = NoLanguage},
     TZleer{tzloc = TextLoc{tlpage = "", tlline = 63}},
     TZtext{tzt = Text0, tzloc = TextLoc{tlpage = "", tlline = 64},
            tztext =
              TextWithMarks{twm =
     ...
     TZmarkup{tzloc = TextLoc{tlpage = "", tlline = 67},
              tztext = TextWithMarks{twm = "", twmMarks = []},
              tztok = BuchIgnoreEnd, tzlang = NoLanguage},
