...
result5BAD =
    [TZmarkup{tzloc = TextLoc{tlpage = "", tlline = 1},
     ...
     TZmarkup{tzloc = TextLoc{tlpage = "", tlline = 14},
              tztext =
     ...
     TZmarkup{tzloc = TextLoc{tlpage = "", tlline = 21},
              tztext = TextWithMarks{twm = "", twmMarks = []}, tztok = BuchHL2,
              tzlang = English},
